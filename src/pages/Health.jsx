    ...
    <main className="flex-1 pt-16" style={{ background: 'var(--bg)' }}>
      ...
      <section className="py-14 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-x-10 gap-y-4">
          ...
          {/* ── Oskar ── */}
          <h2
            className="flex items-center gap-2.5 text-2xl font-semibold mb-2 md:col-start-1 md:row-start-1"
            style={{ fontFamily: 'var(--heading)', color: 'var(--text-h)' }}
          >
            <PawIcon /> Oskar
          </h2>
          ...
          <div className="md:col-start-1 md:row-start-2">
            <Card icon={<IconHrana />} title="Hrana">
              ...
              bez "pileće masti" na <b>Fish 4 dogs white fish (žuta linija)</b>. Mogu samo reći da je preporodjen.</p>
          ...
          {/* ── Oryx ── */}
          <h2
            className="flex items-center gap-2.5 text-2xl font-semibold mb-2 mt-8 md:mt-0 md:col-start-2 md:row-start-1"
            style={{ fontFamily: 'var(--heading)', color: 'var(--text-h)' }}
          >
            <PawIcon /> Oryx
          </h2>
